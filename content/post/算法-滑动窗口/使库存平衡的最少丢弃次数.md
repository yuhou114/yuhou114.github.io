---
title: "使库存平衡的最少丢弃次数"
description: "本题目为 3679.使库存平衡的最少丢弃次数"
date: 2026-05-24T00:59:06+08:00
lastmod: 2026-05-24T00:59:06+08:00
categories:
    - 算法-滑动窗口
tags:
    - 算法
...
本题目为[3679.使库存平衡的最少丢弃次数](https://leetcode.cn/problems/minimum-discards-to-balance-inventory/description/)
...
类似使用 Map的次数类 思路见[几乎唯一子数组的最大和]({{< relref "post/算法-滑动窗口/几乎唯一子数组的最大和" >}})

本题重点在于 物品丢弃等效于把对应arrivals[i]的值 设为0或者负数来规避Map重复减去已经丢弃过的物品。
